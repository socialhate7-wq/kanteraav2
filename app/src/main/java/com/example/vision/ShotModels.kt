...
data class VisionState(
    ...
    // --- ZERO-LATENCY VIDEO RECORDING & SHARING FOR REACTION POINTS ---
    val isAutoRecordReactionPoints: Boolean = true,
    val isReactionMusicMuted: Boolean = false,
    val reactionVideoFile: java.io.File? = null,
    val reactionHighlightVideoFile: java.io.File? = null,
    val isMuxingReactionAudio: Boolean = false,
    val showReactionVideoFinishedDialog: Boolean = false,
    val reactionHighlightsList: List<HighlightClipInfo> = emptyList()
)
